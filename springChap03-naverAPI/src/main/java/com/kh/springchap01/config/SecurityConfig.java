package com.kh.springchap01.config;
...
public class SecurityConfig {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		"PUT"     : 서버에서 데이터를 업데이트 하기 위한 용도로 
				클라이언트가 수정한 내용을 데이터베이스에 업데이트 하기위해 사용
		"OPTIONS" : 실제로 요청하기 전에 브라우저가 서버한테 해당 데이터에 대해 
				어떤 메서드와 헤더들을 사용할 수 있는지 확인하기 위한 용도
				CORS에서 사전 검사를 요청하는데 많이 사용
		"PATCH" : 데이터에 일부만 업데이트 하기 위한 용도
...
//					.clientId("https://developers.naver.com/apps/#/myapps 안에 적혀있는 Client ID 가지고오기")
		...
		public ClientRegistration kakaoClientRegistration() {
			return ClientRegistration.withRegistrationId("kakao")
					.clientId("75899b2b09c3f586cb5fe39712e52767")
					.clientSecret("2jkWPjduXThIsEeGtj1siqJlNLEzKAsa")
